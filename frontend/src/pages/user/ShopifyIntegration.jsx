            ...
            <div style={{ display: 'grid', gap: '20px' }}>
              ...
              <div style={{
                ...
                <ol style={{ color: 'var(--muted)', paddingLeft: '20px', margin: 0 }}>
                  ...
                  <li>Configure Admin API scopes: read_products, write_products, read_orders, write_orders, write_fulfillments</li>
          ...
          <div style={{ padding: '24px' }}>
            {products.length === 0 ? (
              <div style={{
                ...
                <p style={{ fontSize: '16px', marginBottom: '8px' }}>No products marked for Shopify</p>
                <p style={{ fontSize: '14px' }}>
                  Go to Products → In-house Products and check "Sync to Shopify" on products you want to list
                </p>
              </div>
            ) : (
