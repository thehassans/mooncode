...
export default function InvestorAmounts() {
  ...
  useEffect(() => {
    ...
    return () => {
      try {
        socket && socket.off('investor-remittance.created')
      } catch {}
      try {
  ...
  const totalApproved = remittances
        ...
        <div>
          <div
            style={{
              ...
              marginBottom: '12px',
              background:
                'linear-gradient(135deg, #f59e0b 0%, #fbbf24 25%, #10b981 50%, #059669 75%, #047857 100%)',
          ...
          >
            Manage investor profit withdrawals and track performance
          </div>
        </div>
      </div>
        ...
        >
          <div style={{ display: 'grid', gap: 12 }}>
            ...
            <div style={{ padding: 16, background: 'var(--panel)', borderRadius: 8 }}>
              <div style={{ fontWeight: 700, fontSize: 16, marginBottom: 12, color: '#8b5cf6' }}>
              ...
              <div style={{ display: 'grid', gap: 8 }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  <strong>
                    {detailModal.investor?.investorProfile?.currency || 'SAR'}{' '}
                    {num(detailModal.investor?.investorProfile?.investmentAmount || 0)}
                  </strong>
                </div>
              </div>
            </div>
            ...
            {/* Request Info */}
            <div style={{ padding: 16, background: 'var(--panel)', borderRadius: 8 }}>
              <div style={{ fontWeight: 700, fontSize: 16, marginBottom: 12, color: '#10b981' }}>
                Request Details
              </div>
              <div style={{ display: 'grid', gap: 8 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  <strong style={{ color: '#10b981', fontSize: 18 }}>
                    {detailModal.currency} {num(detailModal.amount)}
                  </strong>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            ...
            {detailModal.investor?.investorProfile?.assignedProducts?.length > 0 && (
              <div style={{ padding: 16, background: 'var(--panel)', borderRadius: 8 }}>
                <div style={{ fontWeight: 700, fontSize: 16, marginBottom: 12, color: '#3b82f6' }}>
                  Assigned Products
                </div>
                <div style={{ display: 'grid', gap: 8 }}>
                  {detailModal.investor.investorProfile.assignedProducts.map(
                    (ap, idx) =>
                      ap.product && (
                        <div
                          key={idx}
                        ...
                        >
                          ...
                          <div style={{ flex: 1 }}>
                            ...
                            <div className="helper" style={{ fontSize: 12 }}>
                              {ap.country || 'All Countries'} • Profit: {detailModal.currency}{' '}
                              {num(ap.profitPerUnit)}/unit
                            </div>
                          </div>
                        </div>
                      )
